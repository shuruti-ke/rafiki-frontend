...
async def chat(
    ...
    try:
        ...
        system_prompt += (
            ...
            "## Proactive employee lookup\n"
            "Whenever a manager or HR admin mentions a person's name (e.g. 'tell me about Sarah', 'how is John doing'), "
            "IMMEDIATELY call get_employee_profile with that name — do NOT ask for clarification first. "
            "Then follow up with other tools (check_objectives, check_leave_balance, get_performance_reviews, etc.) "
