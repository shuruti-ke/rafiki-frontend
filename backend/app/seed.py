"""
Seed canonical product data only.

This script intentionally does NOT create production credentials or org admins.
Use `python -m app.bootstrap_admin` for secure one-time bootstrap admin creation.
"""
import logging
import sys
